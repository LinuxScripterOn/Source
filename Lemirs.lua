...
function Linux.Create(config)
    ...
    local MainShadow = Linux.Instance("ImageLabel", {
        Parent = LinuxUI,
        BackgroundTransparency = 1,
        Size = UDim2.new(0, uiSize.X.Offset + 20, 0, uiSize.Y.Offset + 20),
        Position = UDim2.new(0.5, -(uiSize.X.Offset + 20) / 2, 0.5, -(uiSize.Y.Offset + 20) / 2),
        Image = "rbxassetid://1316045217", -- Imagem de sombra suave
